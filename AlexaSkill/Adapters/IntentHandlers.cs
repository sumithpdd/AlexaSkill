...
{public class IntentHandlers
    {
        ...
        internal static AlexaResponse HelpIntent(Request request)
        {
            var response = new AlexaResponse(
                "To use the Habitat home skill, you can say, Alexa, ask Habitat home for top products, to retrieve the top products or say, Alexa, ask Habitat home for the new products, to retrieve the latest new products. You can also say, Alexa, stop or Alexa, cancel, at any time to exit the Habitat home skill. For now, do you want to hear the Top products or New products?",
                false);
