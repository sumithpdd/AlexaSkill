...
namespace AlexaSkill.Controllers
{
    public class TwitterCompController : Controller
    {
        ...
        {
            var twitter = new TwitterApi(TwitterConfiguration.ConsumerKeyApiKey, TwitterConfiguration.ConsumerSecretApiSecret, TwitterConfiguration.AccessToken, TwitterConfiguration.AccessTokenSecret);
