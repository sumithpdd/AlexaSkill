...
namespace AlexaSkill.Controllers
{
    public class CompetitionWinnersController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            CompetitionWinner competitionWinner = db.CompetitionWinners.Find(id);
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Tweet,ProfileImageUrl,CreatedDate,UpdatedDate")] CompetitionWinner competitionWinner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Tweet,ProfileImageUrl,CreatedDate,UpdatedDate")] CompetitionWinner competitionWinner)
        {
            if (ModelState.IsValid)
            {
